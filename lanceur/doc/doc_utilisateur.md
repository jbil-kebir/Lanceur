...
Si vous saisissez vos identifiants directement sur le site, l'application détecte la soumission du formulaire et vous propose de les **sauvegarder**. Appuyez sur **Sauvegarder** pour que la connexion soit automatique lors des prochaines visites, ou **Non** pour ignorer.
