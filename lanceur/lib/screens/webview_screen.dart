...
class _WebViewScreenState extends State<WebViewScreen> {
      ...
      ..setNavigationDelegate(NavigationDelegate(
        ...
        onPageFinished: (_) async {
          ...
          if (_premiereCharge) {
            ...
            _injecterIdentifiants();
          } else {
            // Une nouvelle page est chargée : si des identifiants ont été
            // capturés sur la page précédente, proposer la sauvegarde.
  ...
  void _injecterIdentifiants() {
    if (widget.login == null || widget.motDePasse == null) return;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          if (_formulaireConnexionDetecte)
            IconButton(
